...
"""
* This script simply grabs raw sensor data (IMU Linear Acceleration) and transforms it the local coordinate system.
...
class Publisher_IMU_acc_tip(Node):
    ...
    def __init__(self):
        ...
        self.matrix = np.array(extracted_data_IMU['IMU_calibration_tip']['acc'])
