...
"""
* This file grabs the magnetic sensor's transformed vector. From it the generalized coordinates are published,
...
class Gen_coords_mag(Node):

    # * function called on creation
    def __init__(self):
        # it insists upon itself
        super().__init__('gen_coords_mag')
        ...
        self.subscription_1 = self.create_subscription(Vector3, '/pc/transformed_mag_1', lambda msg: self.callback_mag(msg, 1), 10)
        self.subscription_2 = self.create_subscription(Vector3, '/pc/transformed_mag_2', lambda msg: self.callback_mag(msg, 2), 10)
        self.subscription_3 = self.create_subscription(Vector3, '/pc/transformed_mag_3', lambda msg: self.callback_mag(msg, 3), 10)
        self.subscription_4 = self.create_subscription(Vector3, '/pc/transformed_mag_4', lambda msg: self.callback_mag(msg, 4), 10)
        ...
        self.publisher_select = {
            ...
            'bot': self.create_publisher(Float64MultiArray, '/pc/gen_coords_mag_bot', 10),
            'top': self.create_publisher(Float64MultiArray, '/pc/gen_coords_mag_top', 10),}
    ...
    def callback_mag(self, msg: Vector3, sensor: int) -> None:
